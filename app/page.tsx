    ...
    <div className="flex flex-col">
      ...
      <section className="flex min-h-[80vh] flex-col justify-center gap-8 pb-24 pt-16">
        ...
        <div className="flex flex-col gap-6">
          ...
          <h1 className="text-6xl font-bold leading-[1.05] tracking-tight sm:text-7xl md:text-8xl lg:text-9xl hero-reveal">
            牧之的云，
            <br />
            <span className="text-muted">AI 产品系统。</span>
          </h1>
          <p className="max-w-xl text-lg leading-relaxed text-ink-2 hero-reveal">
      ...
      <section className="border-t border-line pt-20 pb-16">
        <RevealSection className="mb-14 flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="grid gap-5 sm:grid-cols-2">
          {allProducts.map((p, i) => (
            ...
            >
              <Link
                href={p.href}
                className="card-lift group flex flex-col gap-5 border border-line bg-surface p-7"
              >
                {/* 编号 + 状态 */}
                ...
                <div className="flex items-center justify-between border-t border-line pt-4">
                  ...
                  <span className="arrow-slide text-sm text-muted">
                    →
                  </span>
                </div>
              </Link>
      ...
      {/* ── 底部 CTA ── */}
      <RevealSection className="border-t border-line mt-8 flex flex-col items-start gap-5 pt-16 pb-12">
        <p className="font-mono text-xs tracking-[0.2em] text-muted uppercase">
          Get Started
        </p>
